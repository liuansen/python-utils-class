# -*- coding: utf-8 -*-
# Generated by Django 1.11.14 on 2019-05-22 07:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.BooleanField(default=False, help_text='Designates whether the user can log into this admin site.', verbose_name='\u662f\u5426\u662f\u804c\u5458')),
                ('avatar', spark.thumbs.ImageWithThumbsField(blank=True, max_length=800, null=True, upload_to='avatar/%Y/%m/%d/%H/%M%S')),
        ...
        migrations.AddField(
            model_name='user',
            name='mobile_code',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='zone_user', to='spark.MobileCode', verbose_name='\u624b\u673a\u533a\u53f7'),
        ),
        migrations.AddField(
            model_name='user',
